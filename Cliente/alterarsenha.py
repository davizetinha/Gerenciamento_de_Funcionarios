...
class Alterarsenha(object):
    """
    Configura a interface do usuário para a tela de alterar senha.
    ...
    def setupUi(self, MainWindow):
        """
        Configura a interface do usuário da janela de alteração de senha.

        Parameters:
            MainWindow (QtWidgets.QMainWindow): A referência para a janela principal.
        """
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(787, 546)
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(360, 450, 111, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:28pt; font-weight:600;\">Alterar senha</span></p></body></html>"))
        self.pushButton_4.setText(_translate("MainWindow", "Voltar"))
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">senha antiga:</span></p></body></html>"))
